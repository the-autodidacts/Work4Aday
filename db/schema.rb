...
ActiveRecord::Schema.define(version: 20151130005644) do
  ...
  add_index "messages", ["jobposting_id"], name: "index_messages_on_jobposting_id", using: :btree
  ...
  add_foreign_key "messages", "jobpostings"
end
